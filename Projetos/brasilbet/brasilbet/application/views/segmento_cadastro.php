	...
	<div class="panel-body">
		<form action="{ACAO_FORM}" method="post" class="form-horizontal">
			...
			<div class="form-group {ERRO_BUS_DESCRICAO_SEG}">
				<label for="bus_descricao_seg" class="col-sm-2 control-label">Descrição</label>
				<div class="col-sm-10">
			...
			<div class="form-group {ERRO_BUS_ICONE_SEG}">
				<label for="bus_icone_seg" class="col-sm-2 control-label">Icone</label>
				<div class="col-sm-10">
					<input type="text" class="form-control" id="bus_icone_seg"
						   name="bus_icone_seg" value="{bus_icone_seg}" maxlength="25" autofocus autocomplete="off"/>
				</div>
			</div>
