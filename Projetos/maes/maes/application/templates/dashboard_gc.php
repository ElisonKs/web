					...
					<ul class="nav" id="side-menu">                        
						...
						<li>
							...
							<ul class="nav nav-second-level">
								...
								<li>
									<a style="{DISPLAY_ADMIN}" href="<?php echo site_url('cambista')?>">Cambista</a>
								</li>
								
								<li>
									<a style="{DISPLAY_ADMIN}" href="<?php echo site_url('campeonato')?>">Campeonato</a>
								</li>
								
								<li>
									<a style="{DISPLAY_ADMIN}" href="<?php echo site_url('equipe')?>">Equipe</a>
								</li>
								
								<li>
									<a style="{DISPLAY_ADMIN}" href="<?php echo site_url('jogo')?>">Jogo</a>
								</li>
								
								

								<li>
									<a style="{DISPLAY_ADMIN}" href="<?php echo site_url('main/jogo')?>">Jogo GC</a>
								</li>
